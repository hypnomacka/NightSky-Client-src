...
public class Timer
{
    ...
    {
        this.setTicksPerSecond(p_i1018_1_);
    ...
    public void updateTimer()
    {
        ...
        this.elapsedPartialTicks = (float)((double)this.elapsedPartialTicks + d2 * (double)this.timerSpeed * (double)this.getTicksPerSecond());
