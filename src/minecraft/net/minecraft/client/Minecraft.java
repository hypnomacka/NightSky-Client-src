...
import animeware.gui.splash.SplashProgress;
import animeware.gui.splash.UiSplashScreen;
import animeware.hud.mod.Mods.MotionBlur;
import animeware.util.file.NightSkyAssets;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    //public final AnimewareResourcePack mcAnimewareResourcePack;
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        //this.mcAnimewareResourcePack = new AnimewareResourcePack((new ResourceIndex(gameConfig.folderInfo.assetsDir, gameConfig.folderInfo.assetIndex)).getResourceMap());;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        //UiSplashScreen.renderSplashScreen();
        this.initStream();
        ...
        SplashProgress.setProgress(1, "TextureMap");
        this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
        this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
        this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        this.textureMapBlocks.setBlurMipmapDirect(false, this.gameSettings.mipmapLevels > 0);
        this.modelManager = new ModelManager(this.textureMapBlocks);
        SplashProgress.setProgress(2, "ModelManager");
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);       
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(3, "RenderManager");
        this.itemRenderer = new ItemRenderer(this);
        SplashProgress.setProgress(4, "ItemRenderer");
        this.mcResourceManager.registerReloadListener(this.renderItem);
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        SplashProgress.setProgress(5, "EntityRenderer");
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        SplashProgress.setProgress(6, "ModConfig");
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.renderGlobal = new RenderGlobal(this);
        SplashProgress.setProgress(7, "Mods");
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        SplashProgress.setProgress(8, "Cosmetics");
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
        this.effectRenderer = new EffectRenderer(this.theWorld, this.renderEngine);
        this.checkGLError("Post startup");
        this.ingameGUI = new GuiIngame(this);
        
        NightSky.INSTANCE.startup();
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation(NightSkyAssets.getNightSkyAssets() + "/icon16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation(NightSkyAssets.getNightSkyAssets() + "/icon32.png"));
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        //System.out.println(SocketClient.client.request("start_animeware_cape1", Minecraft.getMinecraft().thePlayer.getGameProfile().getName() + ":owns1"));
        //Animeware.hasSent = true;
        //}
        NightSky.INSTANCE.getDiscordRP().update("Playing Singleplayer", "Version: " + NightSky.INSTANCE.VERSION);
    }
