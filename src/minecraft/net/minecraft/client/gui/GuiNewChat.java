...
public class GuiNewChat extends Gui
{
    ...
    /*public void printChatMessageWithOptionalDeletion(IChatComponent p_146234_1_, int p_146234_2_)
    {
        ...
        if(Animeware.nickhider && message.getFormattedText().contains(mc.thePlayer.getNameClear())) {
        	String msg = message.getFormattedText().replaceAll(mc.thePlayer.getNameClear(), NickHider.getPlayerName());
