...
import animeware.ServerDataFeatured;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
    	NightSky.INSTANCE.getDiscordRP().update("Version: " + NightSky.INSTANCE.VERSION, "Multiplayer Menu");
    	//this.mc.getTextureManager().bindTexture(new ResourceLocation("Animeware/background/old/bgblur.png"));
