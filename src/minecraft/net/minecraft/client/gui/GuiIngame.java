...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if(Booleans.watermark) {
	        //mc.fontRendererObj.drawString(Animeware.INSTANCE.VERSION, 52, 45, -1);
			mc.getTextureManager().bindTexture(new ResourceLocation("Animeware/icons/iconWhite.png"));
			Gui.drawScaledCustomSizeModalRect(900, 0, 50, 50, 50, 50, 50, 50, 50, 50);
			//DrawUtil.draw2DImage(new ResourceLocation("Animeware/icons/iconWhite.png"), ClickGUI.width / 2 - 58, ClickGUI.height / 2 - 130, 137, 135, Color.WHITE);
        }
        ...
        if(!(mc.currentScreen instanceof HUDConfigScreen)) {
        	NightSky.INSTANCE.hudManager.renderMods();
        }
    ...
    {
    	boolean shouldDisplayLegacyAnimationsBooleanVariable = true;
		if (this.mc.thePlayer.getHeldItem() != null && shouldDisplayLegacyAnimationsBooleanVariable) {
			this.attemptSwing();
		}
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
