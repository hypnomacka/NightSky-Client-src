...
public class EntityRenderer implements IResourceManagerReloadListener
{
    		...
    		if (this.debugView) {
    			...
    			if (flag) {
    				...
    				if (Config.zoomMode) {
    					...
    					if (this.scrollTotal < 4.0F) {
    						this.scrollTotal += 0.099F;
    					}
    				}
    			} else {
    				if (this.scrollTotal> 1.0F) {
    					this.scrollTotal -= 0.099;
    				}
    				if (Config.zoomMode) {
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(HudManager.getFreelook().getCameraYaw() + (HudManager.getFreelook().getCameraYaw() - HudManager.getFreelook().getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(HudManager.getFreelook().getCameraPitch() + (HudManager.getFreelook().getCameraPitch() - HudManager.getFreelook().getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = HudManager.getFreelook().getCameraYaw();
                float f2 = HudManager.getFreelook().getCameraPitch();
                ...
                GlStateManager.rotate(HudManager.getFreelook().getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(HudManager.getFreelook().getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - HudManager.getFreelook().getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - HudManager.getFreelook().getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = HudManager.getFreelook().getCameraYaw() + (HudManager.getFreelook().getCameraYaw() - HudManager.getFreelook().getCameraYaw()) * partialTicks + 180.0F;
                float f7 = HudManager.getFreelook().getCameraPitch() + (HudManager.getFreelook().getCameraPitch() - HudManager.getFreelook().getCameraPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if (this.mc.gameSettings.viewBobbing && !Booleans.minimalBobbing)
        {
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if(this.mc.inGameHasFocus && flag && HudManager.getFreelook().overrideMouse())
        {
