...
import animeware.util.backend.WebSockets;
...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderLivingLabel(T entity, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            if(Minecraft.getMinecraft().theWorld != null && Minecraft.getMinecraft().theWorld !=null && !NightSky.hasSent) {
    			//if(!this.hasSent) {
            	    //System.out.println("pinging socket server");
    				//CheckName.DoCheckName();
    				//NightSky.hasSent = true;
            ...
            //if(NightSky.isUser == true) {
            /*if(SocketClient.isUserResult().equals("true")) {
            	if(entityIn instanceof AbstractClientPlayer&& entityIn.ticksExisted > 20) {
            ...
            if(entity instanceof AbstractClientPlayer && Minecraft.getMinecraft().thePlayer.getName().equals("hypnomacka") && entity.ticksExisted > 20 && entity == Minecraft.getMinecraft().thePlayer) {    
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskyowner.png"));
            ...
            } else if(entity instanceof AbstractClientPlayer && CosmeticChecker.isDev(entity) && entity == Minecraft.getMinecraft().thePlayer && entity.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskystaff.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entity.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            }else if(entity instanceof AbstractClientPlayer && Minecraft.getMinecraft().thePlayer.getName().equals("_Marto__") && entity.ticksExisted > 20 && entity == Minecraft.getMinecraft().thePlayer) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskyyt.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entity.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            }else if(entity instanceof AbstractClientPlayer && Minecraft.getMinecraft().thePlayer.getName().equals(Minecraft.getMinecraft().getSession().getUsername()) && entity == Minecraft.getMinecraft().thePlayer && entity.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskywhite.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entity.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            } else {
            	
            }
            //entity instanceof AbstractClientPlayer && Minecraft.getMinecraft().thePlayer.getName().equals("KnownAsR3named") && entity == Minecraft.getMinecraft().thePlayer && entity.ticksExisted > 20
            
            //entity instanceof AbstractClientPlayer  && Minecraft.getMinecraft().thePlayer.getName().equals("abcdegh8") || Minecraft.getMinecraft().thePlayer.getName().equals("KnownAsR3named") || Minecraft.getMinecraft().thePlayer.getName().equals("Slepica") && entity == Minecraft.getMinecraft().thePlayer && entity.ticksExisted > 20
            
            /*if(entityIn instanceof AbstractClientPlayer && SocketClient.isOwner(((AbstractClientPlayer) entityIn).getGameProfile().getName()) == true && entityIn.ticksExisted > 20) {    
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskyowner.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);                        
            } else if(entityIn instanceof AbstractClientPlayer && SocketClient.isDev(((AbstractClientPlayer) entityIn).getGameProfile().getName()) == true && entityIn.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskystaff.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            }else if(entityIn instanceof AbstractClientPlayer && SocketClient.isPurple(((AbstractClientPlayer) entityIn).getGameProfile().getName()) == true && entityIn.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskyyt.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            }else if(entityIn instanceof AbstractClientPlayer && SocketClient.isUser(((AbstractClientPlayer) entityIn).getGameProfile().getName()) == true && entityIn.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskywhite.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            } else {
            ...
            /*if(Minecraft.getMinecraft().theWorld != null && Minecraft.getMinecraft().theWorld !=null) {
    			if(!NightSky.hasSent) {
    				//CheckName.DoCheckName();
    				//if((boolean) SocketClient.client.request("start_animeware", Minecraft.getMinecraft().thePlayer.getGameProfile().getName() + ":true")) {
    					//System.out.println("pinging socket server");
    				//}
            ...
            if(entityIn instanceof AbstractClientPlayer && (boolean)SocketClient.isOwner(((AbstractClientPlayer) entityIn).getGameProfile().getName()) && entityIn.ticksExisted > 20) {    
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskyowner.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);                        
            } else if(entityIn instanceof AbstractClientPlayer && (boolean)SocketClient.isDev(((AbstractClientPlayer) entityIn).getGameProfile().getName()) && entityIn.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskystaff.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            }else if(entityIn instanceof AbstractClientPlayer && (boolean)SocketClient.isPurple(((AbstractClientPlayer) entityIn).getGameProfile().getName()) && entityIn.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskyyt.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            }else if(entityIn instanceof AbstractClientPlayer && (boolean)SocketClient.isUser(((AbstractClientPlayer) entityIn).getGameProfile().getName()) && entityIn.ticksExisted > 20) {
            	Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("Animeware/nightskywhite.png"));
            	Gui.drawModalRectWithCustomSizedTexture(-fontrenderer.getStringWidth(entityIn.getDisplayName().getFormattedText()) / 2 - 12, -2, 10, 10, 10, 10, 10, 10);
            } else {
