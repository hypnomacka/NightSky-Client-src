...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures)
    {
        ...
        else
        {
            ...
            if (flag1)
            {
            if(!"lgbt".equals(entitylivingbaseIn.getCustomNameTag())) {
            	if(Booleans.HitColor) {
            		this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(0.3F);
            	} else if(Booleans.HitColorBlue) {
            		this.brightnessBuffer.put(0.0F);
                    this.brightnessBuffer.put(0.0F);
                    this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(0.3F);
            	} else if(Booleans.HitColorCyan) {
            		this.brightnessBuffer.put(0.0F);
                    this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(0.3F);
            	} else if(Booleans.HitColorPurple) {
            		this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(0.0F);
                    this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(0.3F);
            	} else if(Booleans.HitColorRed) {
            		this.brightnessBuffer.put(1.0F);
                    this.brightnessBuffer.put(0.0F);
                    this.brightnessBuffer.put(0.0F);
                    this.brightnessBuffer.put(0.3F);
            	} else if(Booleans.HitColorChroma) {
            		this.brightnessBuffer.put(Minecraft.getMinecraft().fontRendererObj.drawString("", 0, 0, Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F)));
                    this.brightnessBuffer.put(Minecraft.getMinecraft().fontRendererObj.drawString("", 0, 0, Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F)));
                    this.brightnessBuffer.put(Minecraft.getMinecraft().fontRendererObj.drawString("", 0, 0, Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F)));
                    this.brightnessBuffer.put(0.0F);
            	} else {
            ...
            } else if("lgbt".equals(entitylivingbaseIn.getCustomNameTag())) {
            	this.brightnessBuffer.put(Minecraft.getMinecraft().fontRendererObj.drawString("", 0, 0, Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F)));
                this.brightnessBuffer.put(Minecraft.getMinecraft().fontRendererObj.drawString("", 0, 0, Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F)));
                this.brightnessBuffer.put(Minecraft.getMinecraft().fontRendererObj.drawString("", 0, 0, Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F)));
                this.brightnessBuffer.put(0.0F);
                ...
                {
                	if(Booleans.HitColor) {
                		Shaders.setEntityColor(1.0F, 1.0F, 1.0F, 0.4F);
                	} else if(Booleans.HitColorBlue) {
                		Shaders.setEntityColor(0.0F, 0.0F, 1.0F, 0.3F);
                	} else if(Booleans.HitColorCyan) {
                		Shaders.setEntityColor(0.0F, 1.0F, 1.0F, 0.3F);
                	} else if(Booleans.HitColorPurple) {
                		Shaders.setEntityColor(1.0F, 0.0F, 1.0F, 0.3F);
                	} else if(Booleans.HitColorRed) {
                		Shaders.setEntityColor(1.0F, 0.0F, 0.0F, 0.3F);
                	} else if(Booleans.HitColorChroma) {
                		Shaders.setEntityColor(Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F), Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F), Color.HSBtoRGB((float)(System.currentTimeMillis() % 1000L) / 1000.0F, 0.8F, 0.8F), 0.3F);
                	} else {
                        Shaders.setEntityColor(1.0F, 0.0F, 0.0F, 0.3F);
                	}
                }
