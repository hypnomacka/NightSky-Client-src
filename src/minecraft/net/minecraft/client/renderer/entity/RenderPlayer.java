...
import animeware.cosmetic.impl.Bandana;
import animeware.cosmetic.impl.Cape;
import animeware.cosmetic.impl.CatEars;
import animeware.cosmetic.impl.ChinaHat;
import animeware.cosmetic.impl.CosmeticBlaze;
import animeware.cosmetic.impl.CosmeticCreeperLightning;
import animeware.cosmetic.impl.CosmeticCrystalWings;
import animeware.cosmetic.impl.CosmeticEasterEgg;
import animeware.cosmetic.impl.CosmeticEnchantingGlint;
import animeware.cosmetic.impl.CosmeticEnderCrystal;
import animeware.cosmetic.impl.CosmeticGlasses;
import animeware.cosmetic.impl.CosmeticSheepWool;
import animeware.cosmetic.impl.CosmeticSusanno;
import animeware.cosmetic.impl.CosmeticWings;
import animeware.cosmetic.impl.CosmeticWitchHat;
import animeware.cosmetic.impl.CosmeticWither;
import animeware.cosmetic.impl.CosmeticWitherArmor;
import animeware.cosmetic.impl.CosmeticWitherpet;
import animeware.cosmetic.impl.DogPet;
import animeware.cosmetic.impl.GalaxyWings;
import animeware.cosmetic.impl.Halo;
import animeware.cosmetic.impl.TopHat;
import animeware.cosmetic.impl.eyes.CosmeticEyes;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer> {
	...
	public RenderPlayer(RenderManager renderManager, boolean useSmallArms) {
		...
		//this.addLayer(new Cape(this));
		this.addLayer(new CosmeticWings(this));
		this.addLayer(new GalaxyWings(this));
		this.addLayer(new Halo(this));
		this.addLayer(new TopHat(this));
		this.addLayer(new CosmeticEasterEgg(this));
		this.addLayer(new CosmeticGlasses(this));
		//this.addLayer(new CosmeticSusanoo(this));
		//this.addLayer(new RenderBandana(this));
		this.addLayer(new CosmeticWitchHat(this));
		//this.addLayer(new CosmeticDogPet(this));
		this.addLayer(new CosmeticCrystalWings(this));
		this.addLayer(new CosmeticEyes(this));
		this.addLayer(new CosmeticBlaze(this));
		this.addLayer(new Bandana(this));
		
		//this.addLayer(new CosmeticCreeperLightning(null));
		this.addLayer(new CosmeticEnchantingGlint(this));
		//this.addLayer(new CosmeticEnderCrystal(this));
		//this.addLayer(new CosmeticSheepWool(this, null));
		//this.addLayer(new CosmeticSheepWool(this));\
		
		//this.addLayer(new CosmeticSusanno(this));
		//this.addLayer(new CosmeticWither(this));
		//this.addLayer(new CosmeticWitherArmor(this));
		this.addLayer(new CosmeticWitherpet(this));
		this.addLayer(new CatEars(this));
		this.addLayer(new ChinaHat(this));
		
		//this.addLayer(new DogPet(this));
	...
	protected void renderOffsetLivingLabel(AbstractClientPlayer entityIn, double x, double y, double z, String str,
