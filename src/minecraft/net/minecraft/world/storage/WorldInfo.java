...
public class WorldInfo
{
    ...
    public void setWorldTime(long time)
    {
    	...
    	//int wrldtime = (int) time;
    	/*if(Animeware.night) {
    		this.worldTime = 15000;
    	} else if(Animeware.day) {
    		this.worldTime = 10000;
    		//vecer 14000
    		//rano 22000
    	} else if(Animeware.morning) {
    		this.worldTime = 14000;
    	} else if(Animeware.evening) {
    		this.worldTime = 22000;
		}else {
    		this.worldTime = time;
    }*/
    if(Booleans.night) {
    	this.worldTime = 15000;
    }else if(Booleans.day) {
    	this.worldTime = 10000;
    }else if(Booleans.morning) {
    	this.worldTime = 22000;
    }else if(Booleans.evening) {
    	this.worldTime = 14000;
    }else if(Booleans.timechanger) {
